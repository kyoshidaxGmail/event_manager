...
(function(factory) {
  ...
  newMomentProto.stripTime = function() {
    ...
    if (!this._ambigTime) {
      ...
      this.utc(true);
      // keepLocalTime=true (for keeping *date* value)
  ...
  newMomentProto.stripZone = function() {
    ...
    if (!this._ambigZone) {
      ...
      this.utc(true);
      // keepLocalTime=true (for keeping date and time values)
  ...
  (function() {
    ...
    function splitStringLiteral(s) {
      if (s === '. ') {
        return ['.', ' '];
        // for locales with periods bound to the end of each year/month/date
      } else {
        return [s];
      }
    }
    ...
    function buildSameUnits(chunks) {
      ...
      for ( i = 0; i < chunks.length; i++) {
        ...
        if (chunk.token) {
          ...
          // default to a very strict same-second
        } else if (chunk.maybe) {
  ...
  DragListener.mixin({
    ...
    destroyAutoScroll : function() {
      this.endAutoScroll();
      // kill any animation loop

      // remove the scroll handler if there is a scrollEl
      if (this.isAutoScroll) {
        this.stopListeningTo(this.scrollEl, 'scroll');
        // will probably get removed by unbindHandlers too :(
      }
    },
  ...
  var Grid = FC.Grid = ChronoComponent.extend({
    ...
    clearDragListeners : function() {
      ...
      if (this.segDragListener) {
        ...
        // will clear this.segDragListener
      }
      if (this.segResizeListener) {
        this.segResizeListener.endInteraction();
        // will clear this.segResizeListener
      }
      if (this.externalDragListener) {
        this.externalDragListener.endInteraction();
        // will clear this.externalDragListener
      }
    },
  ...
  Grid.mixin({
    ...
    bindSegHandlerToEl : function(el, name, handler) {
      ...
      el.on(name, this.segSelector, function(ev) {
        ...
        // grab segment data. put there by View::renderEventsPayload
  ...
  var DayTableMixin = FC.DayTableMixin = {
    ...
    getCellDate : function(row, col) {
      ...
      this.getCellDayIndex(row, col)].clone();
    },
  ...
  var DayGrid = FC.DayGrid = Grid.extend(DayTableMixin, {
    ...
    renderDayRowHtml : function(row, isRigid) {
      ...
      return '' + '<div class="' + classes.join(' ') + '">' + '<div class="fc-bg">' + '<table class="' + theme.getClass('tableGrid') + '">' + this.renderBgTrHtml(row) + '</table>' + '</div>' + '<div class="fc-content-skeleton">' + '<table>' + (this.numbersVisible ? '<thead>' + this.renderNumberTrHtml(row) + '</thead>' : ''
      ) + '</table>' + '</div>' + '</div>';
    },
  ...
  DayGrid.mixin({
    ...
    fgSegHtml : function(seg, disableResizing) {
      ...
      return '<a class="' + classes.join(' ') + '"' + (eventDef.url ? ' href="' + htmlEscape(eventDef.url) + '"' : ''
  ...
  View.watch('displayingEvents', ['displayingDates', 'hasEvents'], function() {
    ...
    // if there were event mutations after initialEvents
  }, function() {
  ...
  View.mixin({
    ...
    buildValidRange : function() {
      return this.getUnzonedRangeOption('validRange', this.calendar.getNow()) || new UnzonedRange();
  ...
  var Calendar = FC.Calendar = Class.extend(EmitterMixin, {
    ...
    constructor : function(el, overrides) {
      ...
      // needs to happen after options hash initialized
      this.initCurrentDate();
      this.initEventManager();

      EventManager.call(this);
      // needs options immediately
      this.initialize();
    },
  ...
  Calendar.mixin({
    ...
    recordOptionOverrides : function(newOptionHash) {
      ...
      this.populateOptionsHash();
      // this.options needs to be recomputed after the dynamic override
    }
  });
  ...
  Calendar.prototype.buildBusinessDefs = function(wholeDay, rawComplexDef) {
    ...
    if (rawComplexDef === true) {
      ...
      rawDefs = rawComplexDef;
      requireDow = true;
      // every sub-definition NEEDS a day-of-week
    }
  ...
  var AgendaView = FC.AgendaView = View.extend({
    ...
    renderSkeletonHtml : function() {
      ...
      return '' + '<table class="' + theme.getClass('tableGrid') + '">' + '<thead class="fc-head">' + '<tr>' + '<td class="fc-head-container ' + theme.getClass('widgetHeader') + '"></td>' + '</tr>' + '</thead>' + '<tbody class="fc-body">' + '<tr>' + '<td class="' + theme.getClass('widgetContent') + '">' + (this.dayGrid ? '<div class="fc-day-grid"/>' + '<hr class="fc-divider ' + theme.getClass('widgetHeader') + '"/>' : ''
      ) + '</td>' + '</tr>' + '</tbody>' + '</table>';
    },
    ...
    setHeight : function(totalHeight, isAuto) {
      ...
      this.scroller.clear();
      // sets height to 'auto' and clears overflow
